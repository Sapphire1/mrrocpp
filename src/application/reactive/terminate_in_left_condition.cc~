...
bool terminate_in_left_condition::check(const boost::shared_ptr<mrrocpp::ecp::common::generator::behaviour>& bh)
{

	return true;
}
bool terminate_in_left_condition::check(const mrrocpp::ecp::common::generator::behaviour& bh)const
{
