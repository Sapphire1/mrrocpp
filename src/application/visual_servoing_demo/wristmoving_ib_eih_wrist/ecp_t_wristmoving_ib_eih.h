/*
 * ecp_t_wristmoving_ib_eih.h
 *
 *  Created on: Apr 21, 2010
 *      Author: mboryn
 */

#ifndef ECP_T_WRISTMOVING_IB_EIH_H_
#define ECP_T_WRISTMOVING_IB_EIH_H_
 ...
 *
 */
class ecp_t_wristmoving_ib_eih: public mrrocpp::ecp::common::task::task
{
public:
	ecp_t_wristmoving_ib_eih(mrrocpp::lib::configurator& configurator);
